...
const EditLanguages = (props) => {
    ...
    const removeLanguage = () => {
        AppUserFreelancer.removeFreelancerLanguage(props.language, AuthService.getCurrentUser().id)
    ...
    return (
        <div className="modal-container">
            <form noValidate onSubmit={
                        handleSubmit((data) => {
                            AppUserFreelancer.updateFreelancerLanguage(data, props.language.id);
                            props.closeModal(false);}
                        )
                        }>
                ...
                <div className="modal-content-middle">
                        <TextField className={classes.root} id="language" defaultValue={props.language.language} label="Language" variant="outlined" size="small" sx={{ minWidth: "100%" }}
                ...
                <div className="modal-content-bottom">
                  <p className="remove-language" onClick={removeLanguage} >Remove Language</p>  
