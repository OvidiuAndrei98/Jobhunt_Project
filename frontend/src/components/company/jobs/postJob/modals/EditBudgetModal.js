    ...
    return (
        <div className="modal-container">
            ...
            <form noValidate onSubmit={
                handleSubmit((data) => {
                    props.saveBudget({budget :{paymentType: selectedValue.toUpperCase(), budget: selectedValue === "hourly" ? `$${data.budget_from}-$${data.budget_to}/hr` : `$${data.budget}`}});
                ...
                <div className="flex-row">
                    ...
                    <div className="flex-row" style={{justifyContent:"flex-end", marginTop:"30px"}}>
                        ...
                        <Button type="submit" style={{background:"#F0540C", marginLeft:"20px"}} variant="contained" sx={{borderRadius:"25px", padding:"10px 40px",marginBottom:"20px", height:"0"}}>Next</Button>
                    </div>
            </form>
        </div>
    )
