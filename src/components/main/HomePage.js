        ...
        <section style={{position:"relative", width:"100%", height:"100%", display:"flex", flexDirection:"column"}}>
            ...
            <div className="homepage-text">
                ...
                <div className="buttons">
                    <Button style={{background:"#F0540C"}} variant="contained" sx={{borderRadius:"25px", padding:"10px 20px", height:"0", marginTop:"10%"}}>Find Work</Button>
                    <Button style={{background:"#F0540C"}} variant="contained" sx={{borderRadius:"25px", padding:"10px 20px", height:"0", marginTop:"10%"}}>Find Talent</Button>
